    ...
    public class BetRepositoryIntegrationTests
    {
        ...
        public void Setup()
        {
            var configuration = new ConfigurationBuilder()
                ...
                {
        { "ConnectionStrings:DefaultConnection", "Server=CLLEVIOSERBIANO;Database=BettingApp_Test;Trusted_Connection=True;TrustServerCertificate=True;" }
                })
                .Build();

            _repo = new BetRepository(configuration);
